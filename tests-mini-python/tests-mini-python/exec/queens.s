...
__check_0_entry:
    ...
    movq    -160(%rbp),  %rax     
    movq    %rax,       -24(%rbp)
    jmp __check_1_forCondBlock
__check_1_forCondBlock:
    movq    -144(%rbp), %rax
    pushq   %rax
    movq    -64(%rbp), %rax
    popq    %rdi
...
__check_2forBody:
    ...
    movq    -8(%rbp),  %rax     
    movq    %rax,       -40(%rbp)
    jmp __check_3_ifCondBlock
__check_3_ifCondBlock:
    movq    -168(%rbp),  %rax
    pushq   %rax
    movq    (%rax), %rax
    cmpq    $4, %rax
...
__count_0_entry:
    ...
    movq    -248(%rbp),  %rax     
    movq    %rax,       -152(%rbp)
    jmp __count_1_ifCondBlock
__count_1_ifCondBlock:
    movq    -224(%rbp), %rax
    pushq   %rax
    movq    -136(%rbp), %rax
    popq    %rdi
...
__count_5forBody:
    ...
    movq    -48(%rbp),  %rax     
    movq    %rax,       -152(%rbp)
    jmp __count_6_ifCondBlock
__count_6_ifCondBlock:
    movq    -200(%rbp),  %rax
    pushq   %rax
    movq    -152(%rbp),  %rax
    pushq   %rax
